...
- Spatial layout: EXTERIOR backyard. Rocket left-center standing upright on a small patch of dewy grass, its open hatch facing the child. Hero center, both bare feet planted firmly on the grass lawn (NOT on the rocket, NOT on the porch step). {COMPANION_NAME} perched on the lip of the open hatch lower-left (the hatch frame is a solid metal ring — the companion is sitting on that ring, not floating). Porch step and warm yellow porch light lower-right. Apple tree with its three little lanterns far right. Sky filling the upper two-thirds, three shy stars upper-left and crescent moon upper-right.
- Hero pose: Standing in soft pajamas, both bare feet planted flat on the dewy grass lawn (a dry grass surface, not inside the rocket), head tilted gently toward the rocket, one small hand resting flat on its silver side at chest height, the other hand loose at the side, mouth parted in a small wondering half-smile, eyes wide and curious (match attached hero sheet exactly).
- Companion ({COMPANION_NAME}): Perched on the solid metal lip of the open hatch ring (sitting on the hatch edge itself, NOT inside the rocket, NOT floating in air), body angled toward the hero, head lifted up with big shining hopeful eyes, a soft encouraging smile, one paw/limb resting on the hatch edge — clearly inviting the child in.
...
- Exclusions: no text, no letters, no numbers, no borders or frames, no full night yet, no daytime sun, no other people. {HERO} is NOT inside the rocket yet, NOT on the porch step, NOT on the apple-tree branch, NOT airborne — both feet are on the grass. {COMPANION_NAME} is NOT inside the rocket cockpit yet, NOT flying/floating, NOT on the porch — perched on the hatch lip only.
...
- Hero pose: Seated on the padded cockpit bench INSIDE the sealed bubble-dome, body leaning forward against the dome glass, both hands pressed flat to the inside of the glass at chest height, eyes huge with delight, mouth open in a bright delighted laugh-shout, hair lifting slightly from the lift-off. Pajamas still on.
- Companion ({COMPANION_NAME}): Seated on the cockpit bench close beside the hero inside the sealed dome, body turned toward the glass, head tilted up in shared excitement, a wide open grin, paws/limbs braced lightly on the dome's inside wall.
...
- Spatial layout: Midground center is the child fully ENCLOSED inside a clear shimmering bubble helmet (a soft rainbow-rimmed sphere wrapping head AND body), drifting upright in open space a few feet from the rocket. Beside and slightly right is {COMPANION_NAME} ALSO fully enclosed inside their own separate bubble helmet, drifting at the same height as the hero's shoulder. The silver rocket hovers just behind them with its dome partly open. Background: the warm smiling yellow moon center, ringed planet lower-left, comet upper-right, rosy nebula upper-left, triangle of golden stars middle-right, silver stars scattered.
- Hero pose: Drifting upright fully ENCLOSED inside the bubble helmet sphere, pajamas still on, arms floating loose at chest-height, one knee slightly lifted in delighted weightlessness, head tipped back in a bright laughing smile, eyes wide and shining, a little jar of stardust tucked under one arm. The bubble helmet's rainbow-rimmed edge is visible AROUND the entire body.
- Companion ({COMPANION_NAME}): Fully ENCLOSED inside their own separate bubble helmet sphere, drifting just right of the child at shoulder-height, body turned softly toward the hero, head tilted in amused wonder, a warm wide grin, paws/limbs floating loose. The two bubble helmets are separate spheres drifting close but not merged.
...
- Exclusions: no text, no letters, no numbers, no borders or frames, no scary dark void, no cold blue-black, no unfriendly creatures. {HERO} is NEVER outside the bubble helmet in open space; the rainbow-rimmed sphere always fully encloses head AND body. {COMPANION_NAME} has their OWN separate bubble helmet — they are not sharing one. Neither is standing on any surface — they are drifting freely in open space.
- Bottom-text safe zone: bottom ~22%.
- Art style: warm watercolor.
...
- Spatial layout: Midground center is the meteor, drifting in open space about one meter in front of the pair at roughly chest-height, paused mid-arc in its bow, tail arcing behind it (the meteor is NOT touching the hero's bubble helmet, NOT landing on anything — it hovers in open space). Midground left is the child fully enclosed in their bubble helmet sphere, drifting upright in open space, upper body bent forward in a matching bow. Midground right is {COMPANION_NAME} fully enclosed in their own separate bubble helmet, drifting just behind the hero's right shoulder in open space, watching with shared delight. Background: the three golden stars upper-right in their locked triangle, moon peeking in from the right edge, a hint of ringed planet lower-left.
- Hero pose: Drifting upright fully ENCLOSED in the bubble helmet sphere (the rainbow rim visible all around body), upper body bent forward in a playful courtly bow, one arm swept out to the side in a mock-flourish, face turned toward the meteor with a bright laughing grin.
- Companion ({COMPANION_NAME}): Fully ENCLOSED in their own separate bubble helmet sphere, drifting just behind and slightly right of the hero's shoulder, body turned toward the scene, head tilted in amused wonder, a soft happy smile, one paw/limb lifted in a tiny matching wave.
...
- Exclusions: no text, no letters, no numbers, no borders or frames, no scary fiery crashing meteor — this one is small, round-faced, and courtly. The meteor is NOT touching the hero or companion, NOT inside either bubble helmet, NOT crashing into anything — it drifts in open space in front of them. {HERO} is NOT outside the bubble helmet, NOT riding the meteor, NOT holding it.
- Bottom-text safe zone: bottom ~22%.
- Art style: warm watercolor.
- Continuity check: hero, companion, and cosmos match attached sheets.
...
- Spatial layout: Foreground is the powdery pale moon surface with soft round crater dimples — a solid dry dust surface that reads clearly as ground underfoot. Midground center is the moon sheep, standing with all four hooves planted on the moon-dust surface, wool bursting gold. Midground left is the child fully enclosed in their bubble helmet sphere, both bare feet planted on the moon-dust surface (the bubble helmet rests lightly on the ground — the pair can walk on the moon surface while still enclosed in the helmet), body bent forward mid-laugh, hands clapped to the face in delight. Midground right is {COMPANION_NAME} fully enclosed in their own bubble helmet sphere, also standing on the moon-dust surface just right of the hero, one paw/limb lifted to a soft open mouth in a gasp. Background: a soft drop-off of the moon's curve into the cosmos, with the ringed planet lower-left, nebula upper-left, and a scatter of silver stars.
- Hero pose: Standing lightly on the moon-dust surface with both bare feet planted on the powdery ground (still fully enclosed inside the bubble helmet sphere, but the sphere touches the ground), body bent forward at the waist mid-laugh, both hands clapped to the cheeks in delighted surprise, eyes scrunched in a bright wide laugh, shoulders lifted.
- Companion ({COMPANION_NAME}): Standing just right of the hero on the moon-dust surface, all paws/limbs/feet planted on the ground (fully enclosed inside their own bubble helmet sphere touching the ground), body turned toward the sheep, head tipped in awe, one paw/limb lifted to a small open mouth in a soft "oh" gasp, eyes huge.
...
- Spatial layout: Midground center-right is the robot drifting freely in open space at chest-height to the hero (the robot has NO bubble helmet — it is a space-native robot, floating on its own), jar held out in front of it. Midground left is the child fully enclosed in their bubble helmet sphere, drifting upright in open space, head thrown back mid-laugh. Midground upper-right is {COMPANION_NAME} fully enclosed in their own bubble helmet sphere, drifting in open space just above the hero's shoulder, watching with bright amusement. Background: the candy-striped comet upper-right in its anchor position, a trail of silver stars, warm moon glow from the left edge.
- Hero pose: Drifting upright fully ENCLOSED in the bubble helmet sphere in open space (not standing on any surface), head thrown back mid-laugh, both hands clasped to the stomach, shoulders shaking, eyes scrunched, mouth wide open in a snort-giggle.
- Companion ({COMPANION_NAME}): Fully ENCLOSED in their own separate bubble helmet sphere, drifting in open space just above and right of the hero's shoulder, body turned toward the robot, head tipped in bright amusement, a wide open grin, one paw/limb lifted in a small clap.
...
- Spatial layout: Foreground is the soft mint-turquoise solid surface of the ringed planet — clearly a dry powdery mineral ground underfoot, NOT water. Midground left is the child fully enclosed in their bubble helmet sphere, both bare feet planted on the mint-turquoise ground (the bubble helmet touches the ground), bent slightly forward, both hands up in a wave. Midground center is the baby alien sitting directly on the mint-turquoise ground (no bubble helmet — it is a native of this planet), six arms spread wide in a full-body wave. Midground right is {COMPANION_NAME} fully enclosed in their own bubble helmet sphere, standing just behind and right of the hero on the mint surface (all paws/feet on the ground), lifting one paw/limb in a small wave. Background: the pale mint rings of the planet arcing across upper-left-to-upper-right, warm moon glow from upper-right, rosy nebula upper-left, a scatter of silver stars.
- Hero pose: Standing lightly on the solid mint-turquoise planet surface with both bare feet planted on the ground (still fully enclosed inside the bubble helmet sphere), body bent slightly forward in a friendly posture, both arms raised at shoulder-height waving wide, face lit up in a warm welcoming laugh-smile, eyes kind and bright.
- Companion ({COMPANION_NAME}): Standing just behind and right of the hero on the mint solid surface (all paws/feet on the ground, fully enclosed inside their own bubble helmet sphere), body turned toward the alien, one paw/limb lifted in a small polite wave, head tilted in a soft smiling hello.
...
- Exclusions: no text, no letters, no numbers, no borders or frames, no scary alien, no sharp or predatory design — the alien is plump, round-faced, pastel, and clearly a baby with a bib-shape on its tummy. No other grown-up aliens. {HERO} and {COMPANION_NAME} are NOT floating above the planet, NOT outside their bubble helmets — both are standing on the solid planet surface while still enclosed in bubble helmets. The baby alien is NOT inside either bubble helmet. No water or liquid on the surface — the ground is dry mineral.
- Bottom-text safe zone: bottom ~22%.
- Art style: warm watercolor.
...
- Spatial layout: Foreground lower-center is the dewy grass lawn — a solid dry grass surface. Midground center is the hero sitting cross-legged directly on the grass lawn (bare feet and legs on the grass, NOT on the porch step, NOT on the rocket), looking up. Midground left is {COMPANION_NAME} curled close against the hero's side, body resting directly on the grass lawn beside the hero's hip. Midground lower-left is the silver rocket resting upright on the grass a short step away from the pair (the rocket is on the lawn, dome open — the pair is NOT inside it). Midground right is the porch step with its warm yellow light pooling outward. Far right is the apple tree with its three glowing lanterns. Background upper two-thirds is the deep-indigo-violet night sky filled with a generous scatter of warm silver-gold stars, the crescent moon upper-right, and — as a tiny visual callback — a faint curl of the stardust ribbon low on the horizon, still humming home.
- Hero pose: Sitting cross-legged directly on the dewy grass lawn (both legs folded and resting on the grass, NO bubble helmet anymore — back home on Earth), head tipped back and slightly to the side in soft sleepy wonder, one small hand resting open on the grass toward the rocket, the other arm draped gently around {COMPANION_NAME}, eyes half-closed in a peaceful smile, pajamas the same as page 1.
- Companion ({COMPANION_NAME}): Curled close against the hero's side directly on the grass lawn (body resting on the grass, NO bubble helmet) in a soft happy circle, body tucked warm, head also tipped up to the stars, eyes half-closed, a content full smile.
