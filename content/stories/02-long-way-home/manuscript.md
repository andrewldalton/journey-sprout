...
- Spatial layout: Foreground lower-right is the smooth driftwood log resting on the sand. Midground is the child, slightly left of center, standing with both bare feet firmly on the wet-but-solid pale golden sand at the edge of the water (NOT in the water, NOT on the driftwood log, NOT in a tide pool — on the dry/wet sand surface). The incoming wave laps just in front of the toes but does not cover the feet. Midground lower-left is one small tide pool with a pink anemone opening in it (the pool is set back from the hero's feet — the hero is NOT standing in it). Background upper-right is the wide blue sea with soft little whitecap crests. Horizon upper-middle is a pale gold hush where sky meets water. No companion yet on the beach.
- Hero pose: Standing with both bare feet planted on the wet sand at the edge of the water (on the solid sand surface, NOT in the water), one hand lifted to shade {HERO_OBJECT} eyes from the sun, weight tipped slightly forward toward the water, head tilted gently to the right, soft curious expression with lips slightly parted (match attached hero sheet exactly).
...
- Exclusions: no text, no letters, no numbers, no borders or frames, no extra people, no companion yet, no underwater view yet, no boats. {HERO} is NOT in the water, NOT in a tide pool, NOT on the driftwood log — both feet on the sand only. No bubble shield yet (that magic arrives on page 3).
...
- Spatial layout: Foreground lower-right is the dry sand edge just above the small lapping wave. Midground center-left is the child with both sneakered feet planted on the dry sand (NOT in the water), body half-turned toward the water with one palm open; just to the child's right is {COMPANION_NAME}, also standing on the dry sand (NOT in the water), close beside the hero's hip. Midground center is the pair of glowing pearls hovering above the water surface at the pair's chest-height with soft golden halos (the pearls float in open air over the shallows, not sitting on any surface). Background upper-right is the bright blue sea stretching to the horizon; a faint curl of the friendly sea turtle's shell is just visible breaking the surface far out at shoulder-height in the water — quiet promise of who sent the pearls.
- Hero pose: Standing with both sneakered feet planted firmly on the dry sand just above the water's edge (on dry sand surface, NOT in the water), body half-turned toward the camera, left hand reaching out open-palm to receive the floating pearl, eyes wide with soft surprise, mouth small and open in a quiet "oh" (match attached hero sheet exactly).
- Companion ({COMPANION_NAME}): Standing close beside the child on the child's right, all paws/feet planted on the dry sand (NOT in the water, NOT floating), body turned toward the water with the second pearl hovering just before {COMPANION_NAME} at chest-height, head tilted up in gentle wonder, kind eyes lit from below by the pearl's glow, friendly small smile.
...
- Exclusions: no text, no letters, no numbers, no borders or frames, no extra people, no underwater view yet (just the promise), no boats. {HERO} and {COMPANION_NAME} are NOT in the water yet, NOT inside bubble shields yet (bubbles bloom on page 3), NOT swimming. Pearls hover in open air — NOT yet held in hands, NOT submerged.
- Bottom-text safe zone: bottom ~22%.
- Art style: warm watercolor.
...
- Exclusions: no text, no letters, no numbers, no borders or frames, no extra creatures beyond the minnows and distant jellyfish, no boats or surface-world items, no scary dark depth. {HERO} and {COMPANION_NAME} are NEVER outside their bubble shields in open water; hair and clothing stay DRY inside the bubbles. Each has their OWN separate bubble — they are not sharing one. Neither is swimming, kicking, or paddling — the bubble drifts them.
- Bottom-text safe zone: bottom ~22%.
- Art style: warm watercolor.
...
- Spatial layout: Foreground lower-left is a flat white sandy seafloor clearing at the foot of the brain coral with a small scattering of shells. Midground center-left is the child fully enclosed in their bubble shield sphere, hovering just above the sandy clearing (the bottom of the bubble rests lightly on the sand — clearly over the open sand patch, NOT inside any coral, NOT among the sea grass), one hand extended toward the striped fish. Midground right is {COMPANION_NAME} fully enclosed in their own separate bubble shield sphere, hovering beside the child also above the sandy clearing. Background upper-left is the orange brain coral in its anchor position (the brain coral is BEHIND the pair, not wrapping around them). Background right is the purple sea fan. Background middle distance is the pink coral archway softly visible. Green sea grass sways at the lower-right edge (NOT where the pair is standing). Bright sunbeams slant in from the upper-right.
- Hero pose: Drifting upright fully ENCLOSED inside the bubble shield sphere (dry inside, water outside), bubble resting lightly on the open sandy clearing (NOT on coral, NOT in sea grass), one hand extended playfully toward the circling striped fish, other hand loose at {HERO_OBJECT} side, head turned to follow the fish, mouth open in a bright delighted laugh, eyes wide with joy.
- Companion ({COMPANION_NAME}): Fully ENCLOSED inside their own separate bubble shield sphere, bubble hovering just above the open sandy clearing beside the hero (NOT on coral), body angled toward the child and fish, head tilted in amused wonder, a sure warm smile, watching the child's delight with soft shared excitement.
...
- Exclusions: no text, no letters, no numbers, no borders or frames, no extra people, no scary creatures, no surface-world items. {HERO} and {COMPANION_NAME} are NEVER outside their bubble shields in open water, NOT inside or touching any coral, NOT entangled in sea grass — each bubble hovers above the open sandy clearing. The striped fish is NOT inside either bubble.
- Bottom-text safe zone: bottom ~22%.
- Art style: warm watercolor.
...
- Spatial layout: Foreground center is the small octopus with its body tucked inside the nook in the brain coral fold, only head and eight arms emerging from the opening (the octopus stays IN its nook — it is not floating free). Midground center-right is the child fully enclosed in their bubble shield sphere, the bubble hovering in open water a short distance from the coral face (the bubble is clearly NOT touching the coral, NOT inside the nook, NOT pressed against the coral folds), drifting gently sideways, one hand raised inside the bubble in a small friendly wave. Midground upper-right is {COMPANION_NAME} fully enclosed in their own separate bubble shield sphere, hovering in open water a step back and slightly above the child's bubble, watching with a soft encouraging smile. Background is the warm orange folds of the brain coral filling the frame behind them.
- Hero pose: Drifting horizontally fully ENCLOSED inside the bubble sphere (dry inside, water outside) in a soft floating posture with the bubble suspended in open water a short distance off the coral face, body angled toward the octopus, one hand lifted in a small gentle wave at chest height, face lit up with a warm welcoming smile, eyes kind and soft.
- Companion ({COMPANION_NAME}): Fully ENCLOSED inside their own separate bubble shield sphere, bubble hovering in open water a step behind and slightly above the child's bubble, body angled toward the scene, paws/limbs tucked in a comfortable float, head tilted softly, watching the greeting with shared delight.
...
- Exclusions: no text, no letters, no numbers, no borders or frames, no scary tentacled look — the octopus is round-headed, soft-eyed, and small, with a clearly friendly cartoon expression. No extra octopuses. {HERO} is NOT inside any coral nook, NOT outside the bubble, NOT touching the octopus directly — the bubble hovers in open water near but not against the coral. The octopus is NOT inside either bubble; it stays inside its own coral nook.
- Bottom-text safe zone: bottom ~22%.
- Art style: warm watercolor.
- Continuity check: hero, companion, and reef all match attached sheets.
...
- Exclusions: no text, no letters, no numbers, no borders or frames, no scary creatures, no surface-world items, no large predators. {HERO} and {COMPANION_NAME} are NEVER outside their bubbles, NOT touching the coral pillars or arch ceiling, NOT pinned against the archway. The minnows swirl AROUND the outside of the bubbles — NOT inside them.
- Bottom-text safe zone: bottom ~22%.
- Art style: warm watercolor.
...
- Spatial layout: Foreground center is the pair each fully enclosed inside their own separate bubble shield spheres, bubbles hovering just above a wide flat white sandy seafloor clearing side-by-side (the bubbles rest lightly on the sand — clearly in the open clearing, NOT inside any coral, NOT among sea grass), bubbles softly touching at their edges. The shadow — a broad soft oval — slides across the sand just ahead of them from upper-left to lower-right, unmistakable but not yet showing its maker at the top of the frame. Background upper-right is a soft glimpse of the green sea grass cluster. Background upper-left is the orange brain coral in its anchor position, softly blurred. A few bubbles rise in gentle columns.
- Hero pose: Fully ENCLOSED inside the left bubble sphere (dry inside), bubble resting lightly on the open sandy clearing, body still and floating low inside the bubble, head tipped up toward the unseen shape above, one small hand pressed against the INSIDE of the bubble wall reaching toward {COMPANION_NAME}, eyes wide with a small quiet question — not scared, but paused.
- Companion ({COMPANION_NAME}): Fully ENCLOSED inside the right bubble sphere, bubble drifted close to the child's bubble on the same sandy clearing, one paw/limb pressed against the INSIDE of the bubble wall matching the child's hand (the two bubble spheres kiss at the point of contact — the hands touch through two layers of shimmer but neither character is outside their bubble), head tilted up toward the same shape, eyes soft and steady, a reassuring small smile that says *I'm right here*.
...
- Exclusions: no text, no letters, no numbers, no borders or frames — the shadow must read as soft, broad, rounded, and clearly a friendly shape (a gentle round silhouette like a large turtle or ray from below). {HERO} and {COMPANION_NAME} are NEVER outside their bubbles. Their hands touch through the bubble walls. Each bubble is separate, not merged.
- Bottom-text safe zone: bottom ~22%.
- Art style: warm watercolor.
- Continuity check: hero, companion, and reef all match attached sheets.
...
- Spatial layout: Foreground lower third is the pair each fully enclosed inside their own separate bubble shield spheres on the open sandy clearing (the same clearing as page 7 — bubbles resting lightly on the sand), bubbles still softly touching at their edges. Midground-to-upper third is the grandmother sea turtle — a broad gentle silhouette with a patterned green-gold shell, wise warm eyes, a soft hum-smile — gliding through the open water column roughly 2 meters ABOVE the pair's bubbles, slow flippers outspread (the turtle is UP in the water, NOT touching either bubble, NOT landing on the sand). Background lower-right is the brain coral in its anchor position softly blurred; background upper-right is the pink archway in soft distance. Sunbeams slant through the turtle's silhouette making a warm halo around her shell.
- Hero pose: Fully ENCLOSED inside the left bubble sphere (dry inside), bubble resting on the sandy clearing, body unfurled from the still pause, head tipped all the way up to look at the turtle, one arm pointing up inside the bubble in delighted recognition, mouth open in a bright laughing "oh," eyes shining. The earlier pressed-hand is now relaxed open.
- Companion ({COMPANION_NAME}): Fully ENCLOSED inside the right bubble sphere, bubble on the sandy clearing beside the hero's bubble, body turned up toward the turtle, head tilted with soft wonder, a wide warm smile, paws/limbs loose and happy in the drift, clearly sharing the relief and delight.
...
- Exclusions: no text, no letters, no numbers, no borders or frames, no scary creatures, no sharks, no dark depths. {HERO} and {COMPANION_NAME} are NEVER outside their bubbles. The turtle is UP in the water column, NOT on the sand with them, NOT inside either bubble — she glides above the pair.
- Bottom-text safe zone: bottom ~22%.
- Art style: warm watercolor.
- Continuity check: hero, companion, and reef all match attached sheets.
...
- Spatial layout: Foreground lower-left is the edge of the hollow's coral rim (the pair have just drifted PAST this rim into the hollow's open interior). Midground center-left is the child fully enclosed in their bubble shield sphere, the bubble drifting in the open water just inside the hollow's entrance (clearly in the OPEN interior, NOT touching the coral walls, NOT inside any anemone, NOT tangled in the light kelp), both hands lifted softly inside the bubble in wonder. Midground center-right is {COMPANION_NAME} fully enclosed in their own separate bubble shield sphere, bubble drifting in open water beside the child's bubble. Midground right is the grandmother turtle settled directly on the sandy clearing floor of the hollow (her body is ON the sand, NOT drifting, facing toward the pair with a warm smile — she has no bubble, she is a sea creature native to this place). Background is the hollow's interior: pastel anemones (soft pink, butter-yellow, pale coral) opening along the lower walls, pale blue-green light kelp strands rising like slow lanterns (along the walls, NOT where the pair floats), glowing pearls scattered in the coral walls in warm gold clusters, the domed ceiling curving overhead.
- Hero pose: Fully ENCLOSED inside the bubble sphere (dry inside), bubble drifting in the hollow's open interior (NOT on any surface yet, NOT touching walls or kelp), both hands lifted softly inside the bubble near the face in wonder, head turning slowly to take in the whole hollow, mouth open in a soft quiet "oh," eyes wide and full of light from the pearls.
- Companion ({COMPANION_NAME}): Fully ENCLOSED inside their own separate bubble shield sphere, bubble drifting in the hollow's open interior close beside the child's bubble (not touching walls or kelp), body turned forward into the hollow, head tipped in shared wonder, a soft full smile, paws/limbs relaxed and drifting, eyes lit warmly by the pearl-glow.
...
- Exclusions: no text, no letters, no numbers, no borders or frames, no scary creatures, no dark depths, no predators, no surface-world items. {HERO} and {COMPANION_NAME} are NEVER outside their bubbles, NOT touching the coral walls or anemones, NOT inside the light kelp. The turtle is NOT inside either bubble; she rests on the sandy clearing below.
- Bottom-text safe zone: bottom ~22%.
- Art style: warm watercolor.
...
- Hero pose: Floating cross-legged INSIDE the bubble sphere (dry inside), the bubble resting gently on the open sandy clearing, body at ease, hands resting loose in the lap inside the bubble, head tilted softly toward the turtle, a calm full-hearted smile, eyes warm and bright with quiet joy.
- Companion ({COMPANION_NAME}): Curled close beside the child INSIDE their own separate bubble sphere, bubble resting on the sandy clearing beside the hero's bubble, body tucked in a soft happy circle, head settled with eyes softly on the turtle, smile content and warm, paws/limbs relaxed — the posture of a friend who has shared a wonderful day.
...
- Exclusions: no text, no letters, no numbers, no borders or frames, no scary creatures, no surface-world items, no predators, no way-home cottage — the story ends here inside the magic, not back at the beach. {HERO} and {COMPANION_NAME} are NEVER outside their bubbles, NOT on the turtle's back, NOT on anemones — both bubbles rest on the open sandy clearing. Each bubble is separate.
- Bottom-text safe zone: bottom ~22%.
- Art style: warm watercolor.
